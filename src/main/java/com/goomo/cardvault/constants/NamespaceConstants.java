...
/**
 * This class used to create constants for url name space for payback and GI wallet.
 * Create new interface if new client is added and respective method signatures.
 * 
