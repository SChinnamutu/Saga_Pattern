...
/**
 * This class created to define the algo before implementing the entire api's. Kind of POC for algo required.
 * @author Manjunath Jakkandi
 *
 */
public class ManageCard {
	
	public static final String aesKey = "0102030405060708";
	public static void initManageCard() {
		...
		try {
			...
			String preEncCardDetails = CryptoUtils.encrypt(cardDetails, aesKey);
			System.out.println("preEncCardDetails :: "+preEncCardDetails);
			String preDecryptCardDetails = CryptoUtils.decrypt(preEncCardDetails, aesKey);
	...
	private static void test() {
		String encCard = "zQMMMuxDUc38ycrhtIYpzTfutSlT/YxCnqwxzYk8/Oz/KJFiapfPc9tOmRcNuGHJ2/SICtabNqQKBZokfGBmj44vjeg7xym9r4ePJVwCcPri8EoC";
		String cckey = "0154790401547904";
		String decCardDetails = decryptEncCardDetails(encCard.trim(), cckey.trim());
		System.out.println("decCardDetails >> "+decCardDetails);
	}
	*/
