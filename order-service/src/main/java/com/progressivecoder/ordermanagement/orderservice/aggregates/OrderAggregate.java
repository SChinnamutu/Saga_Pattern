...
import com.progressivecoder.ecommerce.events.OrderCancelEvent;
...
public class OrderAggregate {
    ...
    @CommandHandler
    public void on(OrderCancelCommand createOrderCommand){
        AggregateLifecycle.apply(new OrderCancelCommand(createOrderCommand.orderId, createOrderCommand.itemType,
                createOrderCommand.price, createOrderCommand.currency, createOrderCommand.orderStatus));
    }

    @EventSourcingHandler
    protected void on(OrderCancelEvent orderCreatedEvent){
        this.orderId = orderCreatedEvent.orderId;
        this.itemType = ItemType.valueOf(orderCreatedEvent.itemType);
        this.price = orderCreatedEvent.price;
        this.currency = orderCreatedEvent.currency;
